...
resource "aws_route53_record" "fleet_acm_validation" {
  ...
  name    = aws_acm_certificate.fleet.domain_validation_options[0].resource_record_name
  type    = aws_acm_certificate.fleet.domain_validation_options[0].resource_record_type
  records = [aws_acm_certificate.fleet.domain_validation_options[0].resource_record_value]
  ttl     = 60
}
